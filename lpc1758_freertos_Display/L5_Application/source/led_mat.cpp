...
void ledMat::drawGameName(uint8_t x, uint8_t y)
{
    ...
    drawLetter(x+1, y, 'd', color1);     // 10+1, 40
    drawLetter(x+8, y, 'e', color1);
    drawLetter(x+15, y, 'a', color1);
    drawLetter(x-10, y, 't', color2);
    drawLetter(x-3, y, 'h', color2);

    drawLetter(x-10, y-8, 'r', color2);
    drawLetter(x-3, y-8, 'a', color2);
    drawLetter(x+4, y-8, 'c', color2);
    drawLetter(x+11, y-8, 'e', color2);

}

void ledMat::drawStartCondition(uint8_t x, uint8_t y)
{
