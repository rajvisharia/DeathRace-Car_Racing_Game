 ...
 */
#define WIRELESS_NODE_ADDR              180    ///< change 180 for player1 and 180 for player 2
...
#define SYS_CFG_DEFAULT_CPU_CLK (96 * 1000 * 1000UL)    ///< Do not change.  This is the fall-back CPU speed if SYS_CFG_DESIRED_CPU_CLK cannot be attained
