...
public:
    ...
    void drawNumbers(uint8_t x0, uint8_t y0, uint8_t value, uint8_t color);
    void drawFrame();
   ...
   // void checkHit();
    void updateDisplay();
    void clearNumbers(uint8_t x0, uint8_t y0, uint8_t color);
    void clearCar(uint8_t x0, uint8_t y0, uint8_t color1, uint8_t color2);
